...
Load it in Chrome: open `chrome://extensions`, switch on **Developer mode**, click **Load unpacked**, choose `extension/dist`. The first-run screen opens on install.
