...
- **Secondary:** transparent, ink text, 1.5px ink border, same padding; hover fills with paper. The header "Add to Chrome" is this variant at 0.875–0.9375rem with `10px 14–16px`; the card's Close is this variant at 13.5px with `5px 12px`.
